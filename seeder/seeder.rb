...
search_terms.each do |search_term|
  pages << {
      page_type: 'products_listing',
      method: 'GET',
      url: "https://mystique-v2-americanas.b2w.io/search?content=#{search_term}&offset=0&sortBy=relevance&source=nanook&limit=24&suggestion=false&c_b2wSid=469.846063031196620192141153145&c_b2wUid=va_201913311927_801.2812056579871",
      vars: {
          'input_type' => 'search',
